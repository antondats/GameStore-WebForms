...
namespace GameStore.Pages
{
    public partial class Listing : System.Web.UI.Page
    {
        ...
        {
            string game = ((LinkButton)sender).Text;
            Response.Redirect(RouteTable.Routes.GetVirtualPath(null, "game", new RouteValueDictionary() { { "game", game.Replace(' ', '_') } }).VirtualPath);
            SessionHelper.Set(Session, SessionKey.RETURN_URL,
                           Request.RawUrl);
        }
